...
test("storage bridge pushes minimal sync snapshots and ignores page request events", async () => {
  ...
  const browser = {
    storage: {
      sync: area({
        settings: { icon: "16-solid/home", iconColor: "#112233", backgroundColor: "#abcdef", markerDiameter: 36 },
  ...
  assert.deepEqual(locations, [
    { name: "Home", icon: "16-solid/home", iconColor: "#112233", backgroundColor: "#abcdef", markerDiameter: 36, lat: 1, long: 2 },
    { name: "Override", icon: "16-solid/star", iconColor: "#ffffff", backgroundColor: "#2563eb", markerDiameter: 36, lat: 3, long: 4 }
  ]);
